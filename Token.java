...
public class Token {
    public enum Token_Type {
        ...
        Continue ,plusEqual,minusEqual,Boolean_literal,character
    }
 ...
 public Token(String name, int blkNum, int blkOrder, Token_Type token_type, ID_Type id_type,String value){
        this.name = name;
    ...
    public String toString(){
        ...
        return getName()+" , "+getToken_type()+" , "+getId_type()+" , "+getValue()+"\n";
    }
